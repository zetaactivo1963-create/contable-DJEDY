...
async function handleMessage(ctx) {
  try {
    ...
    // ========== AQUÍ VA EL NUEVO CÓDIGO CON BOTONES ==========
    ...
    if (!userState || !userState.step) {
      const keyboard = {
        inline_keyboard: [
          ...
          [
            { text: '📅 Nuevo Evento', callback_data: 'nuevoevento' },
            { text: '📋 Ver Eventos', callback_data: 'eventos' }
          ],
          // Segunda fila: Pagos
          [
            { text: '💰 Depósito', callback_data: 'deposito' },
            { text: '✅ Pago Completo', callback_data: 'pagocompleto' }
          ],
          // Tercera fila: Gastos
          [
            { text: '📉 Gasto Evento', callback_data: 'gasto' },
            { text: '🏢 Gasto Directo', callback_data: 'gastodirecto' }
          ],
